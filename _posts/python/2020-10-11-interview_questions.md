...
2. ## Python은 interpreted language이다. 그 의미는?
...
4. ## Python은 dynamically typed language이다. 그 의미는?
...
7. ## 객체의 복사는 어떻게 하는가? [출처](https://blueshw.github.io/2016/01/20/shallow-copy-deep-copy/)

   * 총 세가지가 존재한다. 1) `=`를 이용한 단순 복사, 2) Shallow Copy (얕은 복사), 3) Deep Copy (깊은 복사)
