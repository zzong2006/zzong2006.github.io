...
$$
\begin{array}{r}
z=0, e^{0}=1 \Rightarrow g(z)=\frac{1}{1+e^{0}}=1 / 2 \\
\\
z \rightarrow \infty, e^{-\infty} \rightarrow 0 \Rightarrow g(z)=\frac{1}{1+e^{-\infty}}=1 \\
\\
z \rightarrow-\infty, e^{\infty} \rightarrow \infty \Rightarrow g(z)=\frac{1}{1+e^{\infty}}=0
\end{array}
$$
...
&\text { when } \quad \theta^{T} x \geq 0, \text { which means that.. }\\
