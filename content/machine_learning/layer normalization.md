...
[[machine_learning/optimization/gradient]] 가 발산하는 경우가 있으므로 훈련하기 까다롭다. 이에 대비하여 [[Learning rate]] 를 작은 값에서 시작해서 최대 값으로 Incremental 하게 증가시키는 learning rate-warm up 방식을 적용한다.
